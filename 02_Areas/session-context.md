---
generated_at: 2026-05-21T00:01:04+00:00
generated_by: ethbot
version: b893c30
freshness_minutes: 0
...
- ⚠️ **LOSS_STREAK** · `BTCUSDT` — 13 consecutive losing SELLs
...
- ⚠️ **LOSS_STREAK** · `SUIUSDT` — 7 consecutive losing SELLs
...
- `BTCUSDT` mit 13 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
...
- `SUIUSDT` mit 7 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
