---
generated_at: 2026-05-19T00:01:03+00:00
generated_by: ethbot
version: 29655ce
freshness_minutes: 0
...
- paper_mode: **False**
- version: `29655ce`
- paper_balance: **$105,711.44** (= starting $100,000 + total_pnl $+5,711.44)
- daily_pnl: **$+0.00**
- today_trades: 0
- lifetime trades: 3640
- lifetime win-rate: 52.1%
...
- ⚠️ **LOSS_STREAK** · `BTCUSDT` — 11 consecutive losing SELLs
...
- `BTCUSDT` mit 11 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
