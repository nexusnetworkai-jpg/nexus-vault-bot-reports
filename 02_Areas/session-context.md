---
generated_at: 2026-05-29T00:01:04+00:00
generated_by: ethbot
version: 6496335
freshness_minutes: 0
...
- ⚠️ **LOSS_STREAK** · `LINKUSDT` — 8 consecutive losing SELLs
- ⚠️ **WIN_RATE_DROP** · `BNBUSDT` — last-5 win-rate 0% (< 30%)
- ⚠️ **LOSS_STREAK** · `BNBUSDT` — 9 consecutive losing SELLs
...
- ⚠️ **LOSS_STREAK** · `TRXUSDT` — 9 consecutive losing SELLs
...
- `LINKUSDT` mit 8 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
...
- `BNBUSDT` mit 9 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
...
- `TRXUSDT` mit 9 consecutive losing SELLs — consecutive_losses-Tracking sollte greifen, aber ein Blick auf die letzten 5 Entry-Reasons kann zeigen, ob ein Pattern-Wechsel im Markt ist.
